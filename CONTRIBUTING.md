...
[GitHub Issues](https://github.com/kobenguyent/insomnial/issues) is the preferred channel for [bug reports](#bug-reports), [features requests](#feature-requests) and [submitting pull requests](#pull-requests).
...
If you plan on helping with development, please read the [Develop Insomnial](README.md#develop-insomnial) section of the README for how to get started. The [Development Overview](DEVELOPMENT.md) may also prove useful for a general overview of the application architecture.

...
const PROTO_PATH = path.resolve('../../packages/insomnial/src/network/grpc/__fixtures__/library/route_guide.proto');
...
export const startGRPCServer = (port: number) => {
  return new Promise<void>((resolve, reject) => {
    ...
    // Enable reflection
    const descriptorSet = '../../packages/insomnial-smoke-test/fixtures/route_guide.bin';
    ...
    server.bindAsync(`localhost:${port}`, grpc.ServerCredentials.createInsecure(), error => {
      ...
      const dbPath = '../../packages/insomnial/src/network/grpc/__fixtures__/library/route_guide_db.json';

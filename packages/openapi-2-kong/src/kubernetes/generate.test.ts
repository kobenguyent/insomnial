  ...
  describe('generateKongForKubernetesConfigFromSpec()', () => {
    ...
    it('handles global plugins', () => {
      ...
      expect(result.documents).toStrictEqual([
        keyAuthPluginDoc('g0'),
        dummyPluginDoc('g1'),
        ingressDoc(0, [keyAuthName('g0'), dummyName('g1')], 'api.insomnial.rest', 'my-api-service-0'),
      ]);
    });
    ...
    it('handles global and server plugins', () => {
      ...
      expect(result.documents).toStrictEqual([
        ...
        keyAuthPluginDoc('s2'),
        dummyPluginDoc('s3'),
        ingressDoc(0, [keyAuthName('g0')], 'api-0.insomnial.rest', 'my-api-service-0'),
        ingressDoc(1, [keyAuthName('s1')], 'api-1.insomnial.rest', 'my-api-service-1'),
        ingressDoc(
          2,
          [keyAuthName('s2'), dummyName('s3')],
          'api-2.insomnial.rest',
          'my-api-service-2',
        ),
      ]);
    });
    ...
    it('handles global and path plugins', () => {
      ...
      expect(result.documents).toStrictEqual([
        ...
        keyAuthPluginDoc('p2'),
        dummyPluginDoc('p3'),
        ingressDoc(0, [keyAuthName('g0')], 'api.insomnial.rest', 'my-api-service-0', '/no-plugin'),
        ingressDoc(1, [keyAuthName('p1')], 'api.insomnial.rest', 'my-api-service-0', '/plugin-0'),
        ingressDoc(
          2,

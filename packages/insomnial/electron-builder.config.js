const BINARY_PREFIX = 'Insomnial.Core';
...
const config = {
  ...
  squirrelWindows: {
    artifactName: `${BINARY_PREFIX}-\${version}.\${ext}`,
    iconUrl:
      'https://github.com/kobenguyent/insomnial/blob/develop/packages/insomnia/src/icons/icon.ico?raw=true',
  },
  portable: {
  ...
  linux: {
    artifactName: `${BINARY_PREFIX}-\${version}.\${ext}`,
    executableName: 'insomnial',
    synopsis: 'The Collaborative API Client and Design Tool',
    category: 'Development',
    desktop: {
      Name: 'Insomnial',
      Comment: 'Insomnial is a cross-platform REST client, built on top of Electron.',

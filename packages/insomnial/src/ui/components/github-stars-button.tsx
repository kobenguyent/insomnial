...
const LOCALSTORAGE_GITHUB_STARS_KEY = 'insomnial:github-stars';
...
export const GitHubStarsButton = () => {
  ...
  useMount(() => {
    ...
    fetch('https://api.github.com/repos/kobenguyent/insomnial')
      .then(data => data.json())
      .then(info => {
        if (!('watchers' in info)) {
  ...
  return (
    <div className="flex select-none rounded-lg divide-x divide-[--hl-md] divide-solid border border-solid border-[--hl-md]">
      <Link>
        <a
          href="https://github.com/kobenguyent/insomnial"
      ...
      {shouldShowCount && (
        <Link>
          <a
            href="https://github.com/kobenguyent/insomnial/stargazers"

...
/**
 * Return path with parameters replaced by insomnial variables
 *
 * I.e. "/foo/:bar" => "/foo/{{ bar }}"
 */
...
/**
 * Imports insomnial definitions of query parameters.
 */
...
/**
 * Imports insomnial definitions of header parameters.
 */
...
/**
 * Parse OpenAPI 3 securitySchemes into insomnial definitions of authentication, headers and parameters
...
/**
 * Imports insomnial request body definitions, including data mock (if available)
 *
...
/**
 * Converts openapi schema of parameters into insomnial one.
 */

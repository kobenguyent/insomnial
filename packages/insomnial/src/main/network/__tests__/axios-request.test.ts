...
describe('axiosRequest used for git-sync', () => {
  ...
  describe('proxy behavior should match the same UX from rest client behavior', () => {
    ...
    it('should set axios proxy key if the user has the insomnial proxy enabled, proxy http url filled in, and there is not a match in the no proxy settings', async () => {
      const mockInsomniaConfigPanelUserSettings: AxiosRequestMockUserSettings = {
        proxyEnabled: true,
        httpsProxy: '',
        httpProxy: 'https://some.proxy.com:8080',
    ...
    it('should set axios proxy key to false if the user has the insomnial proxy enabled, and the proxy http url empty, and there is not a match in the no proxy settings', async () => {
      const mockInsomniaConfigPanelUserSettings: AxiosRequestMockUserSettings = {
        proxyEnabled: true,
        httpsProxy: 'https://some.proxy.com:8080',
        httpProxy: '',
    ...
    it('should set axios proxy key if the user has the insomnial proxy enabled, only proxy http url filled in, and there is not a match in the no proxy settings', async () => {
      const mockInsomniaConfigPanelUserSettings: AxiosRequestMockUserSettings = {
        proxyEnabled: true,
        httpsProxy: '',
        httpProxy: 'https://some.proxy.com:8080',
    ...
    it('should set axios proxy key to prefer https if the user has the insomnial proxy enabled, both proxy urls populated, and there is not a match in the no proxy settings', async () => {
      const mockInsomniaConfigPanelUserSettings: AxiosRequestMockUserSettings = {
        proxyEnabled: true,
        httpsProxy: 'https://some.proxy.com:8080',
    ...
    it('should set axios proxy key if the user has the insomnial proxy enabled, only proxy https url filled in, and there is not a match in the no proxy settings', async () => {
      const mockInsomniaConfigPanelUserSettings: AxiosRequestMockUserSettings = {
        proxyEnabled: true,
        httpsProxy: 'https://some.proxy.com:8080',
        httpProxy: '',

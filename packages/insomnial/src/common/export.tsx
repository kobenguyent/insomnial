...
const showSelectExportTypeModal = ({ onDone }: {
  ...
  const lastFormat = window.localStorage.getItem('insomnial.lastExportFormat');
  ...
  showModal(SelectModal, {
    ...
    onDone: async selectedFormat => {
      if (selectedFormat) {
        window.localStorage.setItem('insomnial.lastExportFormat', selectedFormat);
...
const showSaveExportedFileDialog = async ({
  ...
  const lastDir = window.localStorage.getItem('insomnial.lastExportPath');
...
const writeExportedFileToFileSystem = (filename: string, jsonData: string, onDone: fs.NoParamCallback) => {
  ...
  window.localStorage.setItem('insomnial.lastExportPath', path.dirname(filename));
